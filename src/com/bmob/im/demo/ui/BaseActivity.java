...
public class BaseActivity extends FragmentActivity {
  ...
  /**
   * 打Log ShowLog @return void @throws
   */
  ...
  /**
   * 只有title initTopBarLayoutByTitle @Title: initTopBarLayoutByTitle @throws
   */
  ...
  /**
   * 初始化标题栏-带左右按钮 @return void @throws
   */
  ...
  /**
   * 用于登陆或者自动登陆情况下的用户资料及好友资料的检测更新 @Title: updateUserInfos @Description: TODO @param @return
   * void @throws
   */
  ...
  /**
   * 更新用户的经纬度信息 @Title: uploadLocation @Description: TODO @param @return void @throws
   */
